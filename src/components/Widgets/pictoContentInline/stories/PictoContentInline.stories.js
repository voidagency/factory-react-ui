...
import {PictoContentInlineContainer} from "../pictoContentInline.container";
...
export const Variant1 = () => {
        ...
        items: [
            {
                ...
                description: "بالتصاميم سواء كانت تصاميم مطبوعه ... بروشور او فلاير على سبيل المثال ... او نماذج مواقع انترنت",
            },
            {
                imgUrl: PictoImage,
                title: "هذا هو العنوان",
    ...
    return (
        <DirectionManager dir={rtl ? 'rtl' : 'ltr'}>
            <PictoContentInlineContainer data={rtl ? data_ar : data}/>
        </DirectionManager>
    )
}
...
export default {
    title: 'Dynamic Fields/Picto inline with contenu',
